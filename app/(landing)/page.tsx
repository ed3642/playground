...
import { ChevronDown, GraduationCap, Languages, MapPin, Trophy } from 'lucide-react'
...
const LandingPage = () => {
  return (
    <>
      ...
      <div
        className={cn(
          'md:max-w-screen-xl md:mx-auto mx-2 flex flex-col items-center justify-center space-y-10  relative z-10'
        )}
      >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6 mx-4">
            ...
            <div className="w-full md:w-2/3">
              <p className="text-lg text-muted-foreground">
                ...
                things and build interesting projects. Currently I&apos;m trying to get more
